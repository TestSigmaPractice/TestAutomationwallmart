...
WebUI.click(findTestObject('Object Repository/ProductNavigation/Page_JPetStore Demo/a_K9-BD-01'))

WebUI.click(findTestObject('Object Repository/ProductNavigation/Page_JPetStore Demo/a_EST-6'))
...
WebUI.click(findTestObject('Object Repository/ProductNavigation/Page_JPetStore Demo/a_RP-SN-01'))

WebUI.click(findTestObject('Object Repository/ProductNavigation/Page_JPetStore Demo/a_EST-11'))
